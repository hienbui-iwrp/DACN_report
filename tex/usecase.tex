...
\section{Lược đồ Use-case}
    \subsection{Toàn hệ thống}
        ...
        \end{figure}
    \textbf{Note:} Các Usecase không yêu cầu đăng nhập:
    \begin{itemize}
        \item Đăng kí
...
\subsection{Đặt hàng trực tuyến}
     ...
     \begin{figure}[!htp]
        \centering
        \includegraphics[width=5.5in]{img/UseCase/UseCase-Đặt hàng.drawio.png}
        \
        \newline
...
\subsection{Quản lý sự kiện}
 \begin{figure}[!htp]
    \centering
    \includegraphics[width=4.5in]{img/UseCase/UseCase-Quản lý sự kiện.drawio.png}
    \
    \newline
...
\end{longtable}
    ...
    \subsection{Quản lý chi nhánh}
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=4.5in]{img/UseCase/UseCase-Quản lý chi nhánh.drawio.png}
            \
            \newline
    ...
    \subsection{Quản lý hoạt động kinh doanh}
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=4.5in]{img/UseCase/UseCase-Quản lý hoạt động kinh doanh.drawio.png}
            \
            \newline
    ...
    \subsection{Quản lý nhân viên}    
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=5.5in]{img/UseCase/UseCase-Quản lý nhân viên.drawio.png}
            \
            \newline
    ...
    \subsection{Quản lý tài khoản}
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=5in]{img/UseCase/UseCase-Quản lý tài khoản.drawio.png}
            \
            \newline
    ...
    \subsection{Quản lý kho}
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=4.5in]{img/UseCase/UseCase-Quản lý kho.drawio.png}
            \
            \newline
    ...
    \subsection{Quản lý hàng hóa}
        \begin{figure}[!htp]
            \centering
            \includegraphics[width=5in]{img/UseCase/UseCase-Quản lý hàng.drawio.png}
            \
            \newline
