...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=13cm]{img/database/erd/eerd-customer-order.png}
		\newline
...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=13cm]{img/database/erd/shop_online-đơnhàng.png}
		\newline
...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=13cm]{img/database/erd/branch.png}
		\newline
...
\begin{figure}[!htp]
	\begin{center}
		\includegraphics[width=16cm]{img/database/erd/staff.png}
		\newline
