...
\begin{figure}[!htp]
	\centering
	\hspace*{-1.6cm} \includegraphics[width=19cm]{img/Architecture/general-architect.png}
	\newline
...
\begin{itemize}
	...
	\item Cart Topic: Khi một tài khoản được thêm mới, 1 cart sẽ được thêm tương ứng vào Cart service
	\item Account Topic: Khi một nhân viên được thêm vào hệ thống, 1 tài khoản sẽ được cập nhật tương ứng bên account service
